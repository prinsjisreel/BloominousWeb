        ...
        document.getElementById('addAccountForm').onsubmit = async (e) => {
            ...
            try {
                await db.collection('users').add({
                    ...
                    middleName: document.getElementById('accMiddleName').value,
                    ...
                    username: document.getElementById('accUser').value.trim().toLowerCase(),
                    email: document.getElementById('accUser').value.trim().toLowerCase(),
